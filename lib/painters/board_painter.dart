...
class BoardPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < 20; i++) {
      ...
      final Color colorSingle = isSetA
          ? const Color(0xFF252525)
          : const Color(0xFF505050);
      final Color colorRing = isSetA
    ...
    for (int i = 0; i < 20; i++) {
      ...
      Offset start =
          center +
          Offset(
            cos(angle) * rBullOut * scalePxPerMm,
            sin(angle) * rBullOut * scalePxPerMm,
          );
      Offset end =
          center +
          Offset(
            cos(angle) * rDoubleOut * scalePxPerMm,
            sin(angle) * rDoubleOut * scalePxPerMm,
          );
    ...
    if (cepMm != null && centroidMm != null) {
      ...
      canvas.drawLine(
        cPos - Offset(crossSize, 0),
        cPos + Offset(crossSize, 0),
        centroidPaint,
      );
      canvas.drawLine(
        cPos - Offset(0, crossSize),
        cPos + Offset(0, crossSize),
        centroidPaint,
      );
    }
  ...
  void _drawBits(
    ...
    final Color bitColor = Color.lerp(
      baseColor,
      Colors.black,
      0.4,
    )!.withValues(alpha: 0.5);
    final Paint bitPaint = Paint()
      ..color = bitColor
      ..style = PaintingStyle.fill;
  ...
  bool shouldRepaint(covariant BoardPainter oldDelegate) {
    return oldDelegate.throwsMm != throwsMm ||
        ...
        oldDelegate.showPracticeRings != showPracticeRings ||
